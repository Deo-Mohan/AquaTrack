    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <motion.div 
          ...
          className="lg:col-span-1 flex justify-center h-fit"
        >
          <div className="profile-card w-[300px] rounded-md shadow-xl overflow-hidden z-10 relative cursor-pointer snap-start shrink-0 bg-surface border border-border flex flex-col items-center justify-center gap-3 transition-all duration-300 group">
            ...
            <hr className="w-full group-hover:h-5 h-3 bg-[#58b0e0] group-hover:transition-all group-hover:duration-300 transition-all duration-300 border-none m-0" />
          </div>
        </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSaveProfile} className="space-y-5">
            ...
            {profileData.role !== 'Admin' && (
              <>
                <h3 className="font-semibold text-text mt-8 mb-6 border-b border-border pb-4">Household Details</h3>
