          ...
          >
            ...
            <div className="profile-card w-[300px] rounded-2xl shadow-[0_15px_35px_rgba(0,0,0,0.12)] dark:shadow-[0_15px_35px_rgba(0,0,0,0.4)] hover:shadow-[0_30px_60px_rgba(88,176,224,0.35)] overflow-hidden z-10 relative cursor-pointer bg-surface border border-border/80 flex flex-col items-center justify-center gap-3 transition-all duration-500 [transform-style:preserve-3d] hover:[transform:translateY(-10px)_rotateX(8deg)_rotateY(-8deg)] group">
              ...
              <div className="avatar w-full pt-5 flex items-center justify-center flex-col gap-1 [transform-style:preserve-3d] [transform:translateZ(40px)]">
                <div className="img_container w-full flex items-center justify-center relative z-50 after:absolute after:h-[6px] after:w-full after:bg-[#58b0e0] after:top-4 after:group-hover:size-[1%] after:delay-300 after:group-hover:delay-0 after:group-hover:transition-all after:group-hover:duration-300 after:transition-all after:duration-300 before:absolute before:h-[6px] before:w-full before:bg-[#58b0e0] before:bottom-4 before:group-hover:size-[1%] before:delay-300 before:group-hover:delay-0 before:group-hover:transition-all before:group-hover:duration-300 before:transition-all before:duration-300">
                  {profileData.gender === 'female' ? (
                    <img src="/female_05.svg" alt="Female Avatar" className="size-36 z-50 border-4 border-surface rounded-full group-hover:border-8 group-hover:transition-all group-hover:duration-300 transition-all duration-300 object-cover bg-surface-lighter" />
                  ) : profileData.gender === 'male' && profileData.role === 'Admin' ? (
                    <img src="/male_admin.png" alt="Admin Avatar" className="size-36 z-50 border-4 border-surface rounded-full group-hover:border-8 group-hover:transition-all group-hover:duration-300 transition-all duration-300 object-cover bg-surface-lighter" />
                  ) : profileData.gender === 'male' ? (
                    <img src="/male_03.svg" alt="Household Avatar" className="size-36 z-50 border-4 border-surface rounded-full group-hover:border-8 group-hover:transition-all group-hover:duration-300 transition-all duration-300 object-cover bg-surface-lighter" />
                  ) : (
                    <svg className="size-36 z-50 border-4 border-surface rounded-full group-hover:border-8 group-hover:transition-all group-hover:duration-300 transition-all duration-300 bg-[#58b0e0]" viewBox="0 0 61.8 61.8" xmlns="http://www.w3.org/2000/svg">
                      <g data-name="Layer 2">
