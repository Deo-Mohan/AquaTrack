  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-3 sm:p-4 md:p-6 bg-background relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-[96vw] xl:max-w-[1550px] min-h-[90vh] glass-card rounded-3xl border border-border/30 overflow-hidden shadow-2xl flex flex-col lg:flex-row relative z-10 backdrop-blur-xl">
        ...
        <div className="w-full lg:w-7/12 flex flex-col justify-between p-6 sm:p-10 lg:p-12 relative overflow-hidden bg-transparent">
          ...
          <div className="flex justify-between items-center w-full z-20 mb-6">
            ...
            <label htmlFor="invite-register-switch" className="toggle cursor-pointer ml-auto">
              <input 
                type="checkbox" 
                className="input" 
          ...
          <div className="my-auto w-full z-10 py-6">
            {/* Mobile-only logo */}
            <div className="flex items-center gap-3.5 mb-6 lg:hidden justify-center">
